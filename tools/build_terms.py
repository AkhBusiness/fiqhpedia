...
for ar in sorted(votes):
    ...
    # النقل العلمي مبني على الحروف العربية لا على لغة القارئ، فالإسبانية
    # نسخة من الإنجليزية حرفاً بحرف. اشتقاقها لا نسخها يمنع افتراقهما.
    books[ar]["es"] = books[ar]["en"]
...
terms = {
    ...
    "_rules": {
        ...
        "es": "كالإنجليزية حرفاً بحرف — النقل العلمي مبني على الحروف العربية",
    },
    "books": books,
}
